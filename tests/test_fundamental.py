...
def mock_toolkit():
    ...
    current_ratio_df = pd.DataFrame(
        {"2023": [1.5, 2.0, 0.5], "2024": [1.6, 2.1, 0.4]}, index=["AAPL", "MSFT", "RISK"]
    )
    ...
    op_margin_df = pd.DataFrame(
        {"2023": [0.24, 0.29, 0.07], "2024": [0.25, 0.30, 0.08]}, index=["AAPL", "MSFT", "RISK"]
    )
    ...
    aapl_inc = pd.DataFrame(
        {"2022": [100.0, 10.0, 20.0], "2023": [110.0, 11.0, 22.0], "2024": [120.0, 12.0, 24.0]},
        index=income_idx,
    )

    msft_inc = pd.DataFrame(
        {"2022": [200.0, 20.0, 40.0], "2023": [220.0, 22.0, 44.0], "2024": [240.0, 24.0, 48.0]},
        index=income_idx,
    )

    risk_inc = pd.DataFrame(
        {"2022": [50.0, 1.0, 2.0], "2023": [52.0, 1.0, 2.0], "2024": [54.0, 1.0, 2.0]},
        index=income_idx,
    )
    ...
    aapl_cf = pd.DataFrame(
        {"2022": [25.0, -5.0], "2023": [27.0, -5.0], "2024": [30.0, -6.0]}, index=cf_idx
    )

    msft_cf = pd.DataFrame(
        {"2022": [50.0, -10.0], "2023": [55.0, -10.0], "2024": [60.0, -12.0]}, index=cf_idx
    )

    risk_cf = pd.DataFrame(
        {"2022": [3.0, -2.5], "2023": [3.0, -2.5], "2024": [3.0, -2.5]}, index=cf_idx
    )
